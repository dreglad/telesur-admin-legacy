...
var strings = {
    ...
    "Información del video": {'en': 'Video metadata', 'pt': 'Información del video'},
    ...
    "Subir nuevo clip": {'en': 'Upload new video', 'pt': 'Subir nuevo clip'},
    "Añadir nuevo clip": {'en': 'Add a new video', 'pt': 'Añadir nuevo clip'},
    ...
    'Eliminar': {'en': 'Delete', 'pt': 'Eliminar'},
    ...
    'Reemplazar...': {'en': 'Replace...', 'pt': 'Reemplazar'},
    'Thumbnail del video': {'en': 'Video thumbnail', 'pt': 'Thumbnail del video'},
    'Thumbnail para YouTube': {'en': 'YouTube thumbnail', 'pt': 'Thumbnail para YouTube'},
    ...
    'Replicar en YouTube': {'en': 'Replicate to YouTube', 'pt': 'Replicar en YouTube'},
    'Mantener publicado en YouTube': {'en': 'Keep YouTube copy published', 'pt': 'Mantener publicado en YouTube'},
    'Publicar copia en YouTube': {'en': "Publish on YouTube", 'pt': 'No réplicar en YouTube'},
    'No publicar copia en YouTube': {'en': "Don't publish on YouTube", 'pt': 'No publicar en YouTube'},
    'Despublicar réplica en YouTube': {'en': 'Unpublish YouTube copy', 'pt': 'Despublicar réplica en YouTube'},
    'Replicación en YouTube': {'en': 'YouTube replication', 'pt': 'Replicación en YouTube'},
    'Copia en YouTube': {'en': 'Copy on YouTube', 'pt': 'Copia en YouTube'},
    'Lista de reproducción en YouTube (opcional)': {'en': 'Optional YouTube playlist', 'pt': 'Lista de reproducción en YouTube'},
    'Link en YouTube': {'en': 'YouTube Link', 'pt': 'Link en YouTube'},

    'O bien, link de red social o sitio web desde donde extraer video': {'en': 'Or, you can provide a link to a webpage containing a video for download ', 'pt': 'O bien, link de red social o sitio web desde donde extraer video'},

    'Click para abrir en el sitio web (en nueva pestaña)': {'en': 'Click to view in the website (opens a new tab)', 'pt': 'Click para abrir en el sitio web (en nueva pestaña)'},
